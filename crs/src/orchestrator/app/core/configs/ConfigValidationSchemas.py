...
task_profile_schema = {
    ...
    "properties": {
        ...
        ConfigFieldsEnum.PASSING_TEST_LIMIT.value: {"type": "number", "minimum": 0},
        ConfigFieldsEnum.FAILING_TEST_LIMIT.value: {"type": "number", "minimum": 0},
...
discord_config_schema = {
    ...
    "required": [ConfigFieldsEnum.ENABLE.value, ConfigFieldsEnum.HOOK_URL.value],
    "additionalProperties": False,
}
...
task_default_schema = {
    ...
    "properties": {
        ...
        ConfigFieldsEnum.RUNS.value: {"type": "number", "minimum": 1},
    },
    "required": [
        ConfigFieldsEnum.CONTAINER_PROFILE_ID_LIST.value,
        ConfigFieldsEnum.TASK_PROFILE_ID_LIST.value,
