...
def setup_localization(
    experiment_info: Dict[str, Any], config_info: Dict[str, Any]
) -> None:
    # TODO: make better
    if (
        definitions.KEY_ANALYSIS_OUTPUT in experiment_info
        and len(experiment_info[definitions.KEY_ANALYSIS_OUTPUT]) > 0
...
def setup_tests(experiment_info: Dict[str, Any], config_info: Dict[str, Any]) -> None:
