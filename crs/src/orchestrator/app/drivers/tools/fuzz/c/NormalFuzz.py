...
class NormalFuzz(AbstractFuzzTool):
    ...
    def invoke(
        ...
        tool_folder = (
            join(values.dir_main, "normal_fuzz") if self.locally_running else "/tool"
        )
    ...
    def save_artifacts(self, dir_info: Dict[str, str]) -> None:
        ...
        """
        super(NormalFuzz, self).save_artifacts(dir_info)
