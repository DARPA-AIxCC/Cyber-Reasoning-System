...
class Semgrep(AbstractAnalyzeTool):
    ...
    def __init__(self) -> None:
        ...
        self.image_name = "mirchevmp/semgrep"
    ...
    def pre_process(self, bug_info: Dict[str, Any]) -> None:
        ...
        clean_command = bug_info.get(self.key_clean_script, "make clean")
    ...
    def save_artifacts(self, dir_info: Dict[str, str]) -> None:
        ...
        super(Semgrep, self).save_artifacts(dir_info)
        return
