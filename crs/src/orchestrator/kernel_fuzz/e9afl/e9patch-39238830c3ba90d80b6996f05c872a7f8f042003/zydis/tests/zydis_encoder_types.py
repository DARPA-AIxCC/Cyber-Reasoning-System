...
SIZE_OF_ZYDIS_ENCODER_OPERAND = (
    64
)  # This value must be corrected manually if structure layout changes


ZydisInstructionAttributes = IntFlag(
...
ZYDIS_ENCODABLE_PREFIXES = (
    ZydisInstructionAttributes.ZYDIS_ATTRIB_HAS_LOCK
...
ZydisStackWidth = IntEnum(
    "ZydisStackWidth",
    ["ZYDIS_STACK_WIDTH_16", "ZYDIS_STACK_WIDTH_32", "ZYDIS_STACK_WIDTH_64"],
    start=0,
)


ZydisBranchType = IntEnum(
    "ZydisBranchType",
    [
...
ZydisEncodableEncoding = IntFlag(
