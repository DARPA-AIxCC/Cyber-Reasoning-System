...
if __name__ == "__main__":
    ...
    all_passed = run_test_collection(
        "re_enc_test_cases.json",
        args.zydis_fuzz_re_enc_path,
        convert_re_enc_json_to_crash,
    )
    print()
    print("Running encoding tests:")
    all_passed &= run_test_collection(
        "enc_test_cases.json", args.zydis_fuzz_enc_path, convert_enc_json_to_crash
    )
    print()
